...
window.onload = function() {
    ...
    document.querySelector(".view-mode").onclick = function() {
        ...
        if (darkMode == true) {
            ...
            document.documentElement.style.setProperty('--scroll-thumb-color', '#686868');
            document.documentElement.style.setProperty('--scroll-track-color', '#424242');
            document.documentElement.style.setProperty('--scroll-thumb-hover', '#a1a1a1');
        } else if (darkMode == false) {
            document.documentElement.style.setProperty('--background-color', '#f9f9fb');
            document.documentElement.style.setProperty('--reg-text-color', '#000');
            document.documentElement.style.setProperty('--nav-color', '#5F60A2');
            document.documentElement.style.setProperty('-scroll-thumb-color', '#c1c1c1');
            document.documentElement.style.setProperty('--scroll-track-color', '#f1f1f1');
            document.documentElement.style.setProperty('--scroll-thumb-hover', '#787878');
        }
    }
